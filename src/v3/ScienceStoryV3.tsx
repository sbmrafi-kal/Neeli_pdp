      ...
      <footer className="sv3-resolution">
        ...
        <div className="sv3-resolution-card sv3-resolution-card--path1">
          <div className="sv3-path-header">
            <span className="sv3-path-badge">RECOVERY PATH 01</span>
            <span className="sv3-path-zone">Hair Shaft & Scalp Zone</span>
          </div>
          <h3>Protect the fibre. Support the scalp environment.</h3>
          <p className="sv3-path-desc">
            Direct physical and lipid nourishment targeting hair shaft integrity, cuticle sealing, and soothing scalp balance.
          </p>
          <div className="sv3-path-features">
            <div className="sv3-path-feature">
              <span className="sv3-feature-num">01</span>
              <div>
                <strong>Fibre Penetration</strong>
                <p>Lauric acid in coconut oil penetrates damaged and undamaged hair cuticles to reduce protein loss.</p>
              </div>
            </div>
            <div className="sv3-path-feature">
              <span className="sv3-feature-num">02</span>
              <div>
                <strong>Antioxidant & Scalp Shield</strong>
                <p>Amla & Neeli herbs calm scalp irritation, providing essential traditional antioxidant support.</p>
              </div>
            </div>
          </div>
        </div>

        <div className="sv3-resolution-card sv3-resolution-card--path2">
          <div className="sv3-path-header">
            <span className="sv3-path-badge">RECOVERY PATH 02</span>
            <span className="sv3-path-zone">Dermal Papilla Zone</span>
          </div>
          <h3>Explore the anagen-linked Bhringraj research story.</h3>
          <p className="sv3-path-desc">
            Molecular signals documented in preclinical dermal papilla research associated with the active growing phase.
          </p>
          <div className="sv3-path-features">
            <div className="sv3-path-feature">
              <span className="sv3-feature-num">01</span>
              <div>
                <strong>Anagen Signal Upregulation (FGF-7)</strong>
                <p>Preclinical studies report positive growth-signal markers in dermal papilla cells.</p>
              </div>
            </div>
            <div className="sv3-path-feature">
              <span className="sv3-feature-num">02</span>
              <div>
                <strong>Regression Signal Inhibition (FGF-5)</strong>
                <p>Associated with delaying catagen transition signals to keep follicles in growth phase longer.</p>
              </div>
            </div>
          </div>
        </div>

        <details className="sv3-evidence-note">
          <summary>
            <span className="sv3-evidence-title">
              ...
              How to read the science boundary
            </span>
            <span className="sv3-evidence-toggle">+</span>
          </summary>
          <p>
            Ingredient and preclinical findings describe research mechanisms. They do not establish clinically
            proven regrowth or a guaranteed result from the finished oil. Individual experience can vary based on consistency and application.
          </p>
        </details>
      </footer>
    </section>
